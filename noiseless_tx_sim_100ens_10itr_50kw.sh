#!/bin/bash
#SBATCH --job-name=noiseless_tx_100e_50kw
...
echo "Running $ENS_SIZE member ensemble for $ITRS itrs with initial TX std_dev of $STDDEV_TX_KW kW"

JULIA="/projects/jaca8590/software/julia-1.10.10/bin/julia"

srun --export=ALL --mpi=none $JULIA /projects/jaca8590/Julia/State_Vector_Updates/TX_pwrs_testing/Main-noiseless.jl
